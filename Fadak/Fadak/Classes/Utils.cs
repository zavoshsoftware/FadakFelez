...
namespace Incoming_BektashTravel
{
    public class Utils
    {
        public static string CreateThumbnail(string OriginalFileFullPath, string ItemPath,int width,int height)
        {
            string imageUploadPath = "/Uploads/" + ItemPath + "/Thumbs/";
